...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        list.add(ShapeMatrix.FIRE_DOWN_1);
        list.add( ShapeMatrix.FIRE_DOWN_2);
        list.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(list);

        List<int[][]> listTwo = new ArrayList<int[][]>();
        listTwo.add(ShapeMatrix.FIRE_SIDE_1);
        listTwo.add( ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(listTwo);
