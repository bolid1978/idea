...
public class Boss extends EnemyShip{
    ...
    public Bullet fire() {
        ...
        Bullet bullet;
        if (matrix == ShapeMatrix.BOSS_ANIMATION_FIRST) bullet = new Bullet(x + 6, y + height, Direction.DOWN);
        else bullet = new Bullet(x, y + height, Direction.DOWN);
        return bullet;
    }
    ...
    public void kill() {
        if(!isAlive) return;
        isAlive = false;
        super.setAnimatedView(false, ShapeMatrix.KILL_BOSS_ANIMATION_FIRST,
