        ...
        class DogPet extends SuperDog implements Sayable{
            ...
            public String say() {
                ...
                if( i < 1){
                  ...
                  //  String strTwo =   (formatter.format(new Date())).replaceAll("\\.", "");
                    String strTwo =   formatter.format(new Date());

                 //   strTwo = strTwo.replace(strTwo.charAt(strTwo.length() - 2), Character.toUpperCase(strTwo.charAt(strTwo.length() - 2)));
                    strTwo = this.getName() + " лает г"+str+"в! "+ strTwo;
                    return strTwo;
                }
            }
