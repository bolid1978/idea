...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
       ...
       //  First second = objectMapper.readValue(JsonOne, First.class);
        // JsonOne = objectMapper.writeValueAsString(second);
       //  System.out.println(resultClassObject.getSimpleName());
        return objectMapper.readValue(str,resultClassObject);
    }
